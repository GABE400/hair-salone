...
const MainContent = () => {
  return (
    <div className='main-row three-columns flex justify-center px-10 mx-auto'>
      <article className='column w-80 mx-4 bg-black text-white text-center shadow-md hover:transform hover:translate-y-0 hover:opacity-90'>
        <Image
          src={barberImg}
          alt='Haircut Image'
